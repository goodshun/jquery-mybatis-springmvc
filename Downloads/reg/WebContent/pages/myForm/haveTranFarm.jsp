...
<script type="text/javascript" src="js/haveTranFarm.js"></script>
<style type="text/css">
   .showTabe{
    height:313px;
   	width: 29.33%;
		...
		<div
			...
			<div style="background-color: #ffffff; display: none;" class="product-grid"
				...
				<div class="product-info">
					<div class="product-info-cust  farm_more"detail_id=""  farm_price="" farm_phone="" farm_state="" farm_out_time="" start_time="" end_time="" user_id="">
					</div>
			...
			<div class="panel panel-default">
				...
				<div class="showTabe">
					...
					<div class=" clear-white">
                        <textarea id="message_Content" class="form-control" placeholder="100字以内" style="height: 200px; resize:none;" data-rule="required;length[10~,true]"></textarea>
                    </div>
