...
<title>Insert title here</title>
	...
	<script type="text/javascript" src="js/myDetail.js"></script>
	<style type="text/css">
	.my_btn {
	min-width: 67px;
	border-radius:3px;
			...
			<form class="form-horizontal js-user-query" id = "searchForm">
				<div class="col-md-4 col-sm-6">
					<div class="form-group">
						<label class="col-md-4 col-sm-4 control-label">农场主ID</label>
						<div class="col-md-8 col-sm-8">
							<input type="text" name="job_type" id="card_id"
								class="form-control">
						</div>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="form-group">
						<label class="col-md-4 col-sm-4 control-label">农场名称</label>
						<div class="col-md-8 col-sm-8">
				...
				<div class="col-md-4 col-sm-6">
					<div class="form-group">
						<div class="col-md-8 col-md-offset-2" >
						    <td class="title">
	                     	<button type="button" id='' onclick='queryCard();' class="btn btn-primary my_btn" style="margin-left: 15px;">查询</button>
