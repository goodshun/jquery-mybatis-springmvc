...
/**
 * 面板被激活后触发（在动画完成之后）。
 * 如果 accordion 之前是折叠的，则 ui.oldHeader 和 ui.oldPanel 将是空的 jQuery 对象。
 * 如果 accordion 正在折叠，则 ui.newHeader 和 ui.newPanel 将是空的 jQuery 对象。
 * 注意：由于 activate 事件只有在面板激活时才能触发，当创建 accordion 组件时，最初的面板不会触发该事件。如果您需要一个用于组件创建的钩，请使用 create 事件。
 * @event activate
 * @param  {Object} event
 * @param  {Object} ui ui.newHeader,刚被激活的标题;ui.oldHeader,刚被取消激活的标题;ui.newPanel,刚被激活的面板; ui.oldPanel,刚被取消激活的面板.
 */

/**
 * 面板被激活前直接触发。
 * 可以取消以防止面板被激活。
 * 如果 accordion 当前是折叠的，则 ui.oldHeader 和 ui.oldPanel 将是空的 jQuery 对象。如果 accordion 正在折叠，则 ui.newHeader 和 ui.newPanel 将是空的 jQuery 对象。
 * @event beforeActivate
 * @param  {Object} event
 * @param  {Object} ui ui.newHeader,将被激活的标题;ui.oldHeader,将被取消激活的标题;ui.newPanel,将被激活的面板; ui.oldPanel,将被取消激活的面板.
 */

/**
 * 当创建 accordion 时触发。
 * 如果 accordion 是折叠的，ui.header 和 ui.panel 将是空的 jQuery 对象。
 * @event create
 * @param  {Object} event
 * @param  {Object} ui ui.header,激活的标题;ui.panel,激活的面板.
 */
